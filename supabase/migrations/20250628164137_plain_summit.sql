/*
  # Complete RajniCodes Schema - Landing Page to Product Backend
  
  1. Core Tables
    - `leads` - User registration and basic info
    - `vendor_accounts` - Connected service accounts (Swiggy, Uber, etc.)
    - `payment_methods` - Payment preferences and tokens
    - `preferences` - Personal AI preferences and settings
    - `task_history` - Command history and execution tracking
    - `budgets` - Spending limits and controls
    - `usage_events` - Learning and analytics data
    - `data_policies` - Privacy and retention settings
    
  2. Security
    - Enable RLS on all tables
    - Service role and admin access policies
    - Proper foreign key constraints
    
  3. Performance
    - Strategic indexes for common queries
    - Optimized for real-time AI operations
*/
